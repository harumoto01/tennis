...
$(document).on('pagebeforeshow', '#staff_treatment_list', function() {
	...
	.done(function(response) {
		...
		$.ajax({
		    ...
		    type: 'POST',
		    dataType: 'json',
		    data: { index: es_players+','+es_trainer_record+','+es_doctor_record, filter: { uid: player_uid } },
		    timeout: 10000
		})
		    .done(function(response){
		...
		$.ajax({
		    ...
		    type: 'POST',
		    dataType: 'json',
		    data: { index: es_players+','+es_trainer_record+','+es_doctor_record, filter: {} },
		    timeout: 10000
		})
		    .done(function(response){
			console.log(response);
...
function write_injury_input(index) {
	...
	'<div class="ui-field-contain">'+
	'<label></label>'+
	'<select name="s['+index+'][injury_part]" id="s['+index+'][injury_part]" data-native-menu="false">'+
	...
	'<select name="s['+index+'][injury_cause]" id="s['+index+'][injury_cause]" data-native-menu="false">'+
	...
	'<select name="s['+index+'][diagnosis]" id="s['+index+'][diagnosis]" data-native-menu="false">'+
...
function write_disease_input(index) {
	...
	'<select name="s['+index+'][disease_cause]" id="s['+index+'][disease_cause]" data-native-menu="false">'+
	...
	'<select name="s['+index+'][organ]" id="s['+index+'][organ]" data-native-menu="false">'+
	...
	'<select name="s['+index+'][disease]" id="s['+index+'][disease]" data-native-menu="false">'+
	...
	'<select name="s['+index+'][disease_sub][]" id="s['+index+'][disease_sub]" multiple="multiple" data-native-menu="false">'+

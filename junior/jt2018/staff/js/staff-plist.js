...
//			painmax_f = Math.max.apply(null, Object.values(v3.pain_now.front));
//			painmax_b = Math.max.apply(null, Object.values(v3.pain_now.back));
			painmax_f = 0;
			painmax_b = 0;
			for (i in v3.pain_now.front) {
			    painmax_f = Math.max(painmax_f, v3.pain_now.front[i]);
			}
			for (i in v3.pain_now.back) {
			    painmax_b = Math.max(painmax_b, v3.pain_now.back[i]);
			}

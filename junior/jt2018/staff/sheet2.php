...
if (!isset($_SESSION["uid"]) || !isset($_SESSION["docid"]) ||
    !isset($_SESSION["is_staff"]) || !$_SESSION["is_staff"]) {
...
?>
	  ...
	  <div class="ui-bar ui-bar-a ui-corner-all">【以前から】痛みがある部分をチェックしてください。</div>
...
?>
	  ...
	  <div class="ui-bar">
            ...
            <button id="sheet2_submit" type="submit" data-role="submit" data-theme="b" data-icon="check" style="float:right">入力終了</button>
          </div>
	</div>
      </div>

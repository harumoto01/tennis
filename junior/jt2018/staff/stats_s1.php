...
<html>
  ...
  <body>
    ...
    <div id="staff_stats_s1" data-role="page">
	...
	<a href="../logout.php" class="ui-btn ui-btn-b ui-btn-right ui-corner-all" data-ajax="false">ログアウト</a>
      ...
      <div class="ui-content" role="main">
        ...
        <div class="ui-bar ui-bar-a ui-corner-all">既往歴・アレルギー</div>

	<div style="height:500px">
	  <canvas id="Chart_medhist"></canvas>
	</div>

        <div class="ui-bar ui-bar-a ui-corner-all">痛み・ケガ</div>

	<div style="height:500px">
	  <canvas id="Chart_pain"></canvas>
	</div>

...
<html>
  <head>
    ...
    <script src="js/admin-stats2.js"></script>
  </head>

  <body>

    <div id="admin_stats2" data-role="page">
	...
	<div style="height: 500px">
	  <canvas id="Chart_s1_1"></canvas>
	</div>
	<br/><br/>
	<div style="height: 500px">
	  <canvas id="Chart_s1_2"></canvas>
	</div>

        <div class="ui-bar ui-bar-a ui-corner-all">試合当日セルフチェックシート登録状況</div>
	<div style="height: 500px">
	  <canvas id="Chart_s2_1"></canvas>
	</div>
	<br/><br/>
	<div style="height: 500px">
	  <canvas id="Chart_s2_2"></canvas>
	</div>
